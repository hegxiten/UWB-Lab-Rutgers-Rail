...
lump_sum_file_list, _ = get_moving_test_data_and_timestamp("Moving Test 2 (Virtual Vehicle)", "V3")
...
for test_file in get_moving_test_data_and_timestamp("Moving Test 2 (Virtual Vehicle)", "V2")[0]:
