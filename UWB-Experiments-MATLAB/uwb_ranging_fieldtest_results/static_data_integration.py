...
if __name__ == "__main__":
    test_major_name = "Static Test"
    static_vehicle_name = "V1"
    moving_vehicle_name = "V2"
    lump_sum_file_list, _ = get_test_files_and_survey(test_major_name, static_vehicle_name)
    test_file_list, ground_truth_list = get_test_files_and_survey(test_major_name, moving_vehicle_name)
