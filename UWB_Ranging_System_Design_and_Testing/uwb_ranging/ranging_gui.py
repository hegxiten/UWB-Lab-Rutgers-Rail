...
# This file contains the GUI interface program of the ranging unit to control the
# testing activities. 
# It also displays the necessary program messages to inform the status of the program. 
# Real-time distances, warning messages and hardware status is shown respectively 
# under this program, serving as the main thread of uwb_master.py. 
# This is the GUI interface on individual vehicles. 
