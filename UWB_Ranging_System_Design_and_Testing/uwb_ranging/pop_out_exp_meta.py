...
# This pop up PC program serves as the human-interface for manually recording the
# **Testing/Experiment Metadata**, including:
# -- Experiment Title
# -- Vehicle Number
# -- Movement Direction
# -- Additional Comments
# Tester of the collision avoidance system is supposed to enter the information
# after each individual test is terminated by the GUI testing program. 
# Metadata is saved as text file ending with "-experiment_setup_meta.log"
