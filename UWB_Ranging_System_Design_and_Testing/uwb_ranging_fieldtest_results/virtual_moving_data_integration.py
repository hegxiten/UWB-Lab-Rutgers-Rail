...
if __name__ == "__main__":
    test_major_name = "Moving Test 2 (Virtual Vehicle)"
    static_vehicle_name = "V3"
    moving_vehicle_name = "V2"
    lump_sum_file_list, _ = post_process_get_moving_test_data_and_timestamp(ROOT_DIR, test_major_name, static_vehicle_name, CALIBRATED_CAM_TO_V2B)
    test_file_list, ground_truth_list = post_process_get_moving_test_data_and_timestamp(ROOT_DIR, test_major_name, moving_vehicle_name, CALIBRATED_CAM_TO_V2B)
